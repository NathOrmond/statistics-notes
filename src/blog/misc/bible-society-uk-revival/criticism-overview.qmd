...
1. **Question order effect (most likely):**
...
If question order effects inflated the frequency responses, then:
- The entire basis for the "revival" claim is an artifact
- The "increase" is measurement error, not real behavioural change
- The binary question (which shows a DECREASE) may be more reliable
- **There is no revival—there's just a methodological problem**
