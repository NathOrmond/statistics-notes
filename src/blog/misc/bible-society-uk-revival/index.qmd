...
### 1. [Exploratory Overview](./exploratory-overview.qmd)

Initial data exploration, basic summaries, and detection of red flags:
- Data loading and survey metadata
- Internal consistency checks
- Question format differences
- Basic attendance statistics

### 2. [Weekly Attendance Claim Analysis](./weekly-attendance-claim.qmd)
...
### 3. [Question Order Effects](./question-order-effects.qmd)
...
### 4. [Demographic Analysis](./demographic-analysis.qmd)
